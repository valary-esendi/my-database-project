...
-- (2, 'Cycling', 45, '2023-10-02'),
-- (3, 'Yoga', 60, '2023-10-03'),
-- (4, 'Swimming', 30, '2023-10-04'),
-- (5, 'Weightlifting', 50, '2023-10-05'),
-- (6, 'Hiking', 90, '2023-10-06'),
-- (7, 'Dancing', 45, '2023-10-07'),
-- (8, 'Boxing', 30, '2023-10-08'),
-- (9, 'Pilates', 60, '2023-10-09'),
-- (10, 'Jogging', 35, '2023-10-10'),
-- (11, 'Kickboxing', 50, '2023-10-11'),
-- (12, 'Crossfit', 45, '2023-10-12'),
-- (13, 'Zumba', 60, '2023-10-13'),
-- (14, 'Rowing', 30, '2023-10-14'),
-- (15, 'Rock Climbing', 90, '2023-10-15'),
-- (16, 'Walking', 60, '2023-10-16'),
-- (17, 'Group Exercise', 45, '2023-10-17'),
-- (18, 'Stair Climbing', 30, '2023-10-18'),
-- (19, 'Dance Workout', 40, '2023-10-19'),
-- (20, 'Archery', 50, '2023-10-20'),
-- (21, 'Soccer', 45, '2023-10-21'),
-- (22, 'Tennis', 60, '2023-10-22'),
-- (23, 'Martial Arts', 50, '2023-10-23'),
-- (24, 'Golf', 120, '2023-10-24'),
-- (25, 'Skiing', 90, '2023-10-25'),
-- (26, 'Skating', 30, '2023-10-26'),
-- (27, 'Surfing', 60, '2023-10-27'),
-- (28, 'Ballet', 45, '2023-10-28'),
-- (29, 'Bouldering', 50, '2023-10-29'),
-- (30, 'Body Combat', 45, '2023-10-30'),
-- (31, 'Hula Hoop', 30, '2023-10-31'),
-- (32, 'Badminton', 60, '2023-11-01'),
-- (33, 'Football', 70, '2023-11-02'),
-- (34, 'Kayaking', 50, '2023-11-03'),
-- (35, 'Jump Rope', 20, '2023-11-04'),
-- (36, 'Gardening', 30, '2023-11-05'),
-- (37, 'Running on a treadmill', 25, '2023-11-06'),
-- (38, 'Dog Walking', 35, '2023-11-07'),
-- (39, 'Tai Chi', 60, '2023-11-08'),
-- (40, 'Whale Watching', 2, '2023-11-09'),
-- (41, 'Snorkeling', 90, '2023-11-10'),
-- (42, 'Pilates at Home', 60, '2023-11-11'),
-- (43, 'Home Workout', 40, '2023-11-12'),
-- (44, 'Running on Beach', 50, '2023-11-13'),
-- (45, 'Interval Training', 45, '2023-11-14'),
-- (46, 'Rock Climbing Outdoors', 120, '2023-11-15'),
-- (47, 'Salsa Dancing', 40, '2023-11-16'),
-- (48, 'Aqua Aerobics', 30, '2023-11-17'),
-- (49, 'Stand Up Paddleboarding', 60, '2023-11-18'),
-- (50, 'Volleyball', 50, '2023-11-19');
